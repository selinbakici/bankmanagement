...
public class BranchEmployeeSceneController implements Initializable {
    ...
    private void addBranch(ActionEvent event) {
        ...
        if(branchCode==null || branchCode.isEmpty()){
           warnMsg.setText("Lütfen þube kodunu giriniz.");
           bCode.requestFocus();
            return;
        }
           if(branchName==null || branchName.isEmpty()){
           warnMsg.setText("Lütfen þube adýný giriniz.");
           bName.requestFocus();
            return;
        }
           if(branchLoc==null || branchLoc.isEmpty()){
           warnMsg.setText("Lütfen þube konumunu seçiniz.");
           bLoc.requestFocus();
            return;
        }
    ...
    private void addEmployee(ActionEvent event) {
        ...
        if(branchCode==null || branchCode.isEmpty()){
           warnMsg.setText("Lütfen þube kodunu seçiniz.");
           cBranch.requestFocus();
            return;
        }
           if(empName==null || empName.isEmpty()){
           warnMsg.setText("Lütfen çalýþan adýný giriniz.");
           eName.requestFocus();
            return;
        }                    
            Connection c;
